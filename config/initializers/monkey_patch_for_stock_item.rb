module Spree # http://stackoverflow.com/questions/18668645/overriding-model-in-gem-adding-callback-and-methods
  class StockItem < Spree::Base
    self.whitelisted_ransackable_attributes = [] # Overrides this attribute so that count_on_hand can be updated via FileimportsController. MIGHT HAVE CONSEQUENCES ELSEWHERE.
   end
end
...
module Spree
  class StockItem < Spree::Base
    ...
    self.whitelisted_ransackable_attributes = ['stock_location_id']
